# Infinite Resource Nodes for Dyson Sphere Program
...
## Installation
This mod uses the BepInEx mod patch framework.  So BepInEx must be installed to use this mod.  Find details for installing BepInEx [in their user guide](https://bepinex.github.io/bepinex_docs/master/articles/user_guide/installation/index.html#installing-bepinex-1).  This mod was tested with BepInEx x64 5.4.23.2 and Dyson Sphere Program 0.10.33.27024 on Windows 11.
...
## Change Log
### v1.2.6
 - Will now run with Dyson Sphere Program 0.10.33.27024 update.
### v1.2.5
